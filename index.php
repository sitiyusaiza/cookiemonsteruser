...
<div style="background-image: url('eat.jpg');no-repeat center center fixed; ">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="food-picky-logo.png" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="cookie.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Branch</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Cookies</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                ...
                <center><img src="food-picky-logo.jpg" alt="Paris"width="300" height="220"></center>
                    ...
                    <h2>Popular cookie of the Month</h2>
                    <p class="lead">The easiest way to your favourite cookie</p>
                    <a class="nav-link active" href="branch.php"style="font-size:5vw;">Order Now <span class="sr-only"></span></a> </li>
                </div>
                <div class="row">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with 5 branch in Malaysia.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a your cookie</h3>
                                <p>We"ve got your covered with several type of cookie.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your cookie delivered! And enjoy your cookie! Pay during pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
